      ...
      <section className="flex flex-col gap-6">
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-3 text-sm">
            <p>
              Welcome to Tax Returns Privacy Policy. We value your privacy and
              are committed to protecting your personal information while using
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-3 text-sm">
            ...
            <ul className="list-disc pl-5">
              ...
              <li>Communicate with you regarding your account or support</li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-3 text-sm">
            <p>
              ...
              employ various measures to protect it from unauthorized access,
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-3 text-sm">
            <p>
              ...
              except as necessary to complete your tax return or as required by
              law.
            </p>
          </div>
        </div>
