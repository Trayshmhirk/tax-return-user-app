    ...
    <>
      ...
      <div className="flex flex-col gap-6">
        <p className="text-sm max-w-5xl">
          ...
          deserunt cum, quaerat quae praesentium dolor quos quibusdam quia, quam
          tenetur delectus earum ab illo? Commodi nobis accusamus tempora
          laborum? Doloribus voluptate praesentium provident sed dolor nulla
          exercitationem veniam. Ea magni modi eos quisquam assumenda odio
          numquam ipsam nesciunt. Expedita, vitae dolor similique quibusdam ut
          aut voluptates autem in! Modi, consequuntur.
        </p>
