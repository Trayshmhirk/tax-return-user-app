...
const Faq = () => {
  ...
  const filterByQuestions = (question: QuestionsPropsType) => {
    ...
    return (
      question.questionCategory?.toLowerCase() === selectedFilter.toLowerCase()
    );
  };

  const filterQuestions = faqs
    ? faqs.filter(
        (question) => searchQuestions(question) && filterByQuestions(question)
      )
    : [];
    ...
    <>
      ...
      <div className="flex flex-col gap-6">
        <p className="text-sm max-w-5xl">
          Welcome to our Frequently Asked Questions (FAQ) section, where you can
          find answers to some of the most common questions about our services.
          In this section, you will find the answers to questions about our
          services as a tax returns organization, and how we can help you sort
          your tax return issues. If you can't find the answer to your questions
          here, please feel free to contact us and we'll be happy to assist you.
        </p>
