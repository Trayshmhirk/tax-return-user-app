    ...
    >
      ...
      {isNotApprovedHome && (
        <p className="w-auto z-10 md:w-96">
          Your profile is being verified by the admin and you would be granted
          access to the app once you are verified
        </p>
      )}
          ...
          <div className="flex gap-3">
            ...
            <Button className="flex items-center gap-2 bg-eerieBlack py-[6px] px-3 rounded cursor-pointer shadow-none dark:shadow-none hover-shadow-body">
              ...
              <div className="flex flex-col">
                ...
                <p className="font-bold text-[10px] md:text-base">App Store</p>
              </div>
            </Button>
          </div>
        </div>
